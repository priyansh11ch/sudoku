...
public class GameGenerator {
    ...
    private static int[][] unsolveGame(int[][] solvedGame) {
        ...
        while (!solvable) {
            ...
            while (index < 40) {
                int xCoordinate = rand.nextInt(GRID_BOUNDARY);
                int yCoordinate = rand.nextInt(GRID_BOUNDARY);
    ...
    private static int[][] getSolvedGame() {
        ...
        int[][] newGrid = new int[GRID_BOUNDARY][GRID_BOUNDARY];  // Correctly initialize the 2D array
